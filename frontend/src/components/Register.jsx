  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Create an Acount</h2>
        <p className="mt-2 text-lg leading-8 text-gray-600"> You can create an account to start buying or selling vehicles!  </p>
      </div>
