  ...
  return (
    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 w-[600px]">
     ...
     <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input  type="text"  name="company" id="company" autoComplete="organization"
                className="block w-full rounded-md text-center text-center  border-indigo-600 border-1 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" onChange={(e) => setName(e.target.value)} />
            </div>
          </div>
        ...
        <div className="mt-10">
          <button  className="block w-full rounded-md text-center bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" onClick={() => registerAccount()}> Register </button>
        </div>
